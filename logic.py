...
class Pokemon:
    ...
    def __init__(self, pokemon_trainer):
        ...
        self.name = None
        self.hp = random.randint(20, 300)
        self.power= random.randint(1, 75)
    ...
    async def info(self):
        ...
        return f"The name of your Pokémon: {self.name} {self.hp} untuk darah {self.power} untuk atack"  # Returning the string with the Pokémon's name
